...
EndScene::EndScene(Renderer* renderer, DX11Handler& dx11, Window& window, std::vector<Scene*>& scenes, std::string sceneName, bool& exitGame) : Scene(sceneName, renderer, dx11, window), scenes(scenes), exitGame(exitGame)
{
